...
let cryptobankAElFPopup = new CryptoBankAElFPopup()

window.onmessage = function (event) {
    if (event.data.success && event.data.msg === 'payment-complete') {
        cryptobankAElFPopup.closeIframe()
        cryptobankAElFPopup?.callback(event.data)
        console.log(event.origin)
    } else if (event.data.success && event.data.msg === 'close') {
        cryptobankAElFPopup.closeIframe()
        cryptobankAElFPopup?.onClose()
        console.log(event.origin)
    }
}